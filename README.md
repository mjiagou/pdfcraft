...
<div align="center">
  <img src="public/images/logo.png" alt="PDFtpsh Logo" width="120" height="120" />
...
[![Website](https://img.shields.io/website?url=https%3A%2F%2Fpdf.tpsh.cc%2Fen%2F)](https://pdf.tpsh.cc/en/)
...
**PDFtpsh** is a comprehensive suite of PDF tools designed for privacy and performance. Unlike many online converters, PDFtpsh processes your files entirely within your browser using WebAssembly technology. Your documents **never** leave your device, ensuring maximum security for your sensitive data.
...
PDFtpsh includes a powerful **visual workflow editor** that allows you to chain multiple PDF operations together, creating automated processing pipelines.
...
1.  **Clone the repository**
    ...
    ```bash
    git clone https://github.com/mjiagou/pdfcraft.git
    cd pdfcraft
    ```
...
PDFtpsh provides both pre-built Docker images and Docker Compose for flexible deployment options.

#### Option 1: Use Pre-built Image (Recommended)

The easiest way to run PDFtpsh is using our pre-built image from GitHub Container Registry:
...
Open [http://localhost:8080](http://localhost:8080) to access PDFtpsh.
...
PDFtpsh is configured for static export (`output: 'export'`), which means it can be deployed to any service that supports static website hosting without requiring a Node.js server.
...
PDFtpsh stands on the shoulders of giants. We gratefully acknowledge [BentoPDF](https://github.com/alam00000/bentopdf) for their pioneering work in privacy-first, client-side PDF tools.

Their project served as a significant inspiration and reference for our core logic. While PDFtpsh has been re-engineered for the Next.js ecosystem and extends functionality with unique features like the _Workflow Editor_, we deeply respect the foundation laid by the BentoPDF team.

## 版权信息

messages/zh.json
在这个文件中修改："footer" 这一部分。
