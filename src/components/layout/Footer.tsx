        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <Link href={`/${locale}/contact`} className="p-2 rounded-full bg-[hsl(var(--color-muted))] text-[hsl(var(--color-muted-foreground))] hover:bg-[hsl(var(--color-primary))] hover:text-white transition-all" title={t('navigation.contact')}>
          ...
          <div className="flex flex-col justify-start">
            ...
            >
              <div className="h-10 w-10 rounded-full bg-[hsl(var(--color-success)/0.1)] flex items-center justify-center shrink-0">
