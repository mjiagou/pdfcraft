...
export const toolContentZhTW: Record<string, ToolContent> = {
  ...
  'pdf-multi-tool': {
    ...
    metaDescription: '全能線上PDF頁面編輯器：支援PDF多檔案合併、精準分割、頁面重新排序、旋轉糾偏與頁面擷取。純瀏覽器本地極速運算，無需上傳，完全私密安全。',
    keywords: ['pdf多功能工具', 'pdf編輯器', '合併pdf', '分割pdf', '整理pdf', '一站式pdf工具箱', '免上傳pdf編輯', '本地安全pdf處理'],
    description: `
      <p>TPSH PDF 多功能綜合工具箱是您高效管理與處理 PDF 檔案的全能助手。這款一站式工具將日常高頻的各種 PDF 操作無縫整合，避免在多個獨立軟體或網頁間頻繁切換。</p>
      <p>無論您需要合併多份檔案、將大型 PDF 分解成獨立章節、隨心重排頁面順序、旋轉方向錯誤的頁面，還是快速擷取關鍵頁面，都能在秒級內輕鬆搞定。</p>
      <p><strong>安全承諾：</strong>所有計算完全在您的本地瀏覽器端（基於 WebAssembly）完成，檔案數據絕不上傳至任何伺服器，零外洩風險，保障個人與企業數據安全。</p>
    `,
    howToUse: [
      { step: 1, title: '添加PDF檔案', description: '直接將 PDF 檔案拖曳到頁面上傳區，或點擊“選擇檔案”從本地載入。' },
      { step: 2, title: '選擇所需操作', description: '在功能欄中選擇您要進行的操作：合併、分割、重排頁面、刪除無用頁、旋轉角度或擷取頁面。' },
      { step: 3, title: '微調選項', description: '按需設置具體參數，如旋轉角度、合併次序或擷取頁碼範圍。' },
      { step: 4, title: '極速生成並下載', description: '點擊開始處理，本地秒級渲染完成後即可一鍵儲存新生成的 PDF 檔案。' },
    ],
    useCases: [
      { title: '商務文檔終審排版', description: '在正式提交商務標書或報告前，快速移除冗餘空白頁並統一旋轉頁面方向。', icon: 'file-check' },
      { title: '多部門報告整合', description: '把財務、營運與技術部門分別提交的獨立章節無縫合併為統一的匯報文檔。', icon: 'book-open' },
      { title: '電子檔案按需歸檔', description: '將數百頁的掃描檔案按年度或專題快速拆分擷取，便於分類儲存與檢索。', icon: 'archive' },
    ],
    faq: [
  ...
  'redact-pdf': {
    title: 'PDF塗黑與馬賽克脫敏',
    metaDescription: '對PDF機密信息進行物理塗黑遮蓋、馬賽克打碼或高斯模糊。物理像素級不可逆銷毁底層文字，深度清除元數據，純本地離線處理。',
    keywords: ['pdf塗黑', 'pdf馬賽克', 'pdf打碼', 'pdf脫敏', 'pdf遮蓋', '隱私保護', '抹黑pdf', '模糊pdf'],
    description: `
      <p>PDF塗黑與馬賽克脫敏工具是一款專為高隱私敏感場景設計的安全脫敏利器。不同於常見PDF閱讀器只是在文字上方疊加黑色矩形矢量形狀（底層文字依然可被複制或提取），本工具採用<strong>物理像素級不可逆柵格化銷毀</strong>技術，徹底消滅選區下方的原始文字流和字體信息。</p>
      <p>支援多種脫敏樣式：<strong>實心塗黑/遮蓋</strong>（可選黑、白、紅、灰或自定義安全標籤）、<strong>像素化馬賽克</strong>（可調顆粒大小）以及<strong>平滑高斯模糊</strong>。同時具備深度隱私清理功能，自動清除文檔作者、標題、修改歷史、XMP擴展元數據及批註表單交互對象。</p>
      <p>所有處理100%在您的本地瀏覽器中完成，無需上傳任何文件至雲端伺服器，嚴格守護商業機密與個人隱私。</p>
    `,
    howToUse: [
      { step: 1, title: '上傳PDF文檔', description: '將需要脫敏的PDF拖放至編輯區域，100%純本地離線加載。' },
      { step: 2, title: '框選脫敏區域', description: '使用鼠標拖拽繪製脫敏矩形，支援隨時拖拽手柄調整大小或移動位置。' },
      { step: 3, title: '選擇脫敏樣式與安全選項', description: '可選實心塗黑（黑/白/灰）、像素馬賽克或高斯模糊，並勾選清除元數據和批註。' },
      { step: 4, title: '實時預覽並導出', description: '點擊「預覽脫敏效果」查看真實輸出效果，確認無誤後點擊「應用脫敏並導出」。' },
    ],
    useCases: [
      { title: '商業合約與標書脫敏', description: '對合同中的報價、客戶名稱、簽字印章進行不可逆打碼抹黑，防止商業機密洩露。', icon: 'file-text' },
      { title: '個人隱私合規（GDPR / 個資法）', description: '抹去身份證號、手機號、家庭住址、銀行卡號等敏感私密數據。', icon: 'shield' },
      { title: '醫療病歷與司法材料歸檔', description: '對病患隱私、案件證人姓名進行無痕馬賽克或抹黑，符合司法與醫療公開標準。', icon: 'lock' },
      { title: '公開技術報告與截圖展示', description: '隱藏文檔中的內部伺服器IP、API密鑰或內部組織架構。', icon: 'eye-off' },
    ],
    faq: [
