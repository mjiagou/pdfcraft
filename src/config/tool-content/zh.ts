...
export const toolContentZh: Record<string, ToolContent> = {
  // ==================== 热门工具 ====================
  'pdf-multi-tool': {
    title: 'PDF多功能综合工具箱 (合并/拆分/旋转/提取一站式)',
    metaDescription: '全能在线PDF页面编辑器：支持PDF多文件合并、精准拆分、页面重新排序、旋转纠偏与页面提取。纯浏览器本地极速运算，无需上传，完全私密安全。',
    keywords: ['pdf多功能工具', 'pdf编辑器', '合并pdf', '拆分pdf', '整理pdf', '一站式pdf工具箱', '免上传pdf编辑', '本地安全pdf处理'],
    description: `
      <p>TPSH PDF 多功能综合工具箱是您高效管理与处理 PDF 文档的全能助手。这款一站式工具将日常高频的多种 PDF 操作无缝整合，避免在多个独立软件或网页间频繁切换。</p>
      <p>无论您需要合并多份文件、将大型 PDF 分解成独立章节、随心重排页面顺序、旋转方向错误的页面，还是快速提取关键页面，都能在秒级内轻松搞定。</p>
      <p><strong>安全承诺：</strong>所有计算完全在您的本地浏览器端（基于 WebAssembly）完成，文件数据绝不上传至任何服务器，零泄露风险，保障个人与企业数据安全。</p>
    `,
    howToUse: [
      { step: 1, title: '添加PDF文件', description: '直接将 PDF 文件拖拽到页面上传区，或点击“选择文件”从本地载入。' },
      { step: 2, title: '选择所需操作', description: '在功能栏中选择您要进行的操作：合并、拆分、重排页面、删除无用页、旋转角度或提取页面。' },
      { step: 3, title: '微调选项', description: '按需设置具体参数，如旋转角度、合并次序或提取页码范围。' },
      { step: 4, title: '极速生成并下载', description: '点击开始处理，本地秒级渲染完成后即可一键保存新生成的 PDF 文件。' },
    ],
    useCases: [
      { title: '商务文档终审排版', description: '在正式提交商务标书或报告前，快速移除冗余空白页并统一旋转页面方向。', icon: 'file-check' },
      { title: '多部门报告整合', description: '把财务、运营与技术部门分别提交的独立章节无缝合并为统一的汇报文档。', icon: 'book-open' },
      { title: '电子档案按需归档', description: '将数百页的扫描档案按年度或专题快速拆分提取，便于分类存储与检索。', icon: 'archive' },
    ],
    faq: [
      { question: '处理大型 PDF 会有文件大小限制吗？', answer: 'TPSH PDF 在浏览器本地完成运算，没有强制的服务器大小限制，一般数十兆至数百兆的文档均可流畅处理。' },
      { question: '合并或拆分后是否会丢失书签？', answer: '工具会尽可能完整保留原文档的目录与书签结构，确保阅读体验连贯。' },
      { question: '为什么比其他在线工具快很多？', answer: '因为无需等待缓慢的文件网络上传与云端下载，所有运算完全调用您设备的本地 CPU 算力，秒级生效。' },
    ],
  },

  'merge-pdf': {
    title: 'PDF合并 - 免费在线将多个PDF合并为一个文件 (无损极速)',
    metaDescription: '专业免费的在线PDF合并器：支持拖拽自由排序、保留原始清晰度与书签目录。100%浏览器本地极速拼接，文件零上传，保护您的商业隐私。',
    keywords: ['合并pdf', 'pdf在线合并', '拼接pdf', 'pdf多合一', '组合pdf文件', '免费pdf合并软件', '免上传合并pdf'],
    description: `
      <p>PDF 合并工具支持将多份分散的 PDF 文档快速无缝地组合成一个连贯的单一文档。无论整合合同附件、合并扫描单据还是汇编完整汇报材料，都能一键完成。</p>
      <p>上传文档后，您可以直观地拖拽缩略图自由调整前后顺序。工具采用无损合并引擎，最大程度保留原文档的高清矢量文字、图像品质及目录索引。</p>
      <p><strong>隐私零泄露：</strong>整个合并流程在您的电脑/手机浏览器内存中即时执行，绝不向云端发送任何文件字节，财务与法律文档可放心使用。</p>
    `,
    howToUse: [
      { step: 1, title: '载入待合并PDF', description: '批量将多个 PDF 文档拖拽到网页区域，或点击按钮从本地设备选取。' },
      { step: 2, title: '拖拽调整排版顺序', description: '在预览窗口直接拖拽卡片，自由调整各个文件的先后拼接顺序。' },
      { step: 3, title: '一键合并并导出', description: '点击“合并PDF”按钮，系统本地瞬间组合完毕，点击下载即可。' },
    ],
    useCases: [
      { title: '整合月度/季度财报', description: '将分散的月度账目报表与凭证合并为年度审计文档，便于归档与分享。', icon: 'file-text' },
      { title: '设计与简历作品集组合', description: '将个人简历、荣誉证书、设计成果整合为一份整洁专业的 PDF 作品集。', icon: 'briefcase' },
      { title: '发票与报销凭据归集', description: '将多次出差的行程单、电子发票和报销凭单拼成单份文档，方便财务审核。', icon: 'receipt' },
    ],
    faq: [
      { question: '一次性可以合并多少份 PDF？', answer: '支持一次性批量合并多达数十甚至上百份 PDF 文件。' },
      { question: '合并后会不会降低清晰度？', answer: '不会。合并过程不改变页面内部矢量和图片分辨率，保持源文件 100% 原始清晰度。' },
      { question: '带有密码保护的文件可以合并吗？', answer: '受密码保护加密的文件请先使用本站的“解密PDF”工具解锁后，再进行合并。' },
    ],
  },
  ...
  'split-pdf': {
    title: 'PDF拆分 - 在线免费分割与提取PDF指定页面 (无损高保真)',
    metaDescription: '专业免费的在线PDF拆分与提取工具：支持按页码区间、固定步长分割或单页单独导出。100%浏览器本地极速运算，无需上传，零隐私泄露风险。',
    keywords: ['拆分pdf', 'pdf分割', '提取pdf页面', 'pdf分离器', '在线分割pdf', '截取pdf部分页面', '免费拆分pdf'],
    description: `
      <p>PDF 拆分工具能够将一份冗长庞大的 PDF 快速划分为若干小文件，或单独提取核心指定页面。非常适用于截取合同条款、书籍重点章节、提取申报材料等场景。</p>
      <p>工具提供可视化缩略图交互，支持按自定义页码区间（如 1-3, 5, 8-12）精准提取，或按固定页数均等切分。处理后可单独下载每份文件，或一键打包为 ZIP 归档。</p>
      <p><strong>离线安全：</strong>拆分过程完全在您的本地设备完成，没有任何数据会流入外部网络，全面保护您的敏感档案。</p>
    `,
    howToUse: [
      { step: 1, title: '上传待拆分PDF', description: '将 PDF 文件拖拽进上传区，或点击按钮从您的电脑或手机选取。' },
      { step: 2, title: '选择拆分模式', description: '按需选择“自定义提取指定页码”、“每页单独拆分”或“按固定页数等分”。' },
      { step: 3, title: '输入目标页码', description: '在输入框中填入需要抽取的页码或范围，例如：1-5, 8, 10-15。' },
      { step: 4, title: '本地快速导出', description: '点击开始拆分，完成后可选择单文件下载或一键下载打包好的 ZIP 压缩包。' },
    ],
    useCases: [
      { title: '提取书籍章节', description: '将整本电子书或产品手册拆分为独立章节，方便分发阅读或课件引用。', icon: 'book' },
      { title: '切分批量扫描文档', description: '把复印机一次性多页连续扫描的单据，按交易或客户拆分为独立电子单据。', icon: 'copy' },
      { title: '提炼汇报核心页', description: '从动辄几十页的年度汇报或PPT演示稿中，精准提取关键摘要分发给管理层。', icon: 'presentation' },
    ],
    faq: [
      { question: '支持将每一页都变成一个单独的 PDF 吗？', answer: '支持。选择“每页拆分”模式，即可将 N 页 PDF 秒级拆解为 N 个独立的单页文件并打包下载。' },
      { question: '拆分出来的页面清晰度和原文件一致吗？', answer: '完全一致。采用无损提取逻辑，文字矢量信息和高清图表无任何失真。' },
      { question: '拆分需要消耗服务器流量吗？', answer: '不需要。纯前端 WASM 执行，即便离线断网亦能流畅工作。' },
    ],
  },

  'compress-pdf': {
    title: 'PDF压缩 - 免费在线极限压缩PDF体积 (清晰度自选/安全无上传)',
    metaDescription: '高效专业的在线PDF压缩器：智能优化图像分辨率与字体流，在保持高清可读的前提下将文件体积压缩高达80%。纯本地运行，免上传服务器。',
    keywords: ['压缩pdf', 'pdf在线压缩', '减小pdf大小', '免费缩小pdf体积', 'pdf压缩神器', 'pdf文件过大压缩', '免上传pdf压缩'],
    description: `
      <p>PDF 压缩工具能够大幅精简 PDF 文件体积，轻松解决因文件过大无法通过邮件附件发送、网站上传被阻（如政府申报、考试报名限制 2MB/5MB）等难题。</p>
      <p>工具提供智能多档压缩级别（低压高画质、平衡推荐、极致瘦身），在保持文本极度锐利清晰的同时，对嵌入图片进行高保真重采样与无损流压缩，通常可缩减 50%~80% 空间。</p>
      <p><strong>隐私零风险：</strong>不同于传统需要上传云端排队的压缩网站，TPSH PDF 所有压缩均在您当前浏览器的沙箱内存中完成，机密商业数据无需担忧外泄。</p>
    `,
    howToUse: [
      { step: 1, title: '添加过大PDF文档', description: '拖拽需要缩小的 PDF 文档至界面，或从本地磁盘选取。' },
      { step: 2, title: '挑选压缩档位', description: '根据目标场景选择合适模式：“轻度压缩 (最高画质)”、“推荐平衡”或“强力极限压缩 (最小体积)”。' },
      { step: 3, title: '秒级压缩与下载', description: '点击“开始压缩”，系统将在本地瞬间计算，直观展示缩减百分比并提供即刻下载。' },
    ],
    useCases: [
      { title: '满足邮件附件限制', description: '将动辄上百兆的设计稿或合同压缩至 10MB 以内，确保邮件秒级发送成功。', icon: 'mail' },
      { title: '政企与招聘系统上传', description: '针对人事简历系统、招投标网站对单个附件 2MB/5MB 的严格限制进行定向压缩。', icon: 'globe' },
      { title: '节省存储与带宽', description: '对历史电子账单与长期文档进行批量体积优化，节省设备存储空间与传输流量。', icon: 'hard-drive' },
    ],
    faq: [
      { question: '压缩后文字会变模糊吗？', answer: '不会。PDF 内的矢量文字、排版和几何路径在压缩中始终保持绝对矢量清晰，仅针对高像素图片进行科学优化。' },
      { question: '为什么有些 PDF 压缩比例很小？', answer: '如果原文档主要为纯文本或已经在制作时高度压缩，缩减空间会较小；对于含高清扫描件、相片或插图的 PDF，压缩效果尤为显著。' },
      { question: '文件上传到你们的云端会被留存吗？', answer: '绝对不会！TPSH PDF 绝不上传文件，全部运算由您的浏览器芯片执行，处理完毕即刻释放，绝对安全。' },
    ],
  },

  'edit-pdf': {
    title: '编辑PDF',
    metaDescription: '在线直接编辑PDF正文文本与图像。支持点击段落原位修改、实时自动排版折行，同时保留经典批注与高亮标记。',
    keywords: ['编辑pdf', 'pdf文本编辑', '原位修改pdf', 'pdf直接编辑', 'pdf修改文字', 'pdf正文修改', 'pdf编辑器'],
    description: `
      <p>全新的直接编辑模式采用先进的 PDFium 原生引擎，支持像 Word 一样直接点击 PDF 正文段落进行原位编辑与文字修改，并具备实时智能折行（Live Reflow）排版能力。</p>
      <p>同时提供右侧属性控制坞（文本字号、颜色、行高、对齐方式）、图片原位替换与翻转，以及全文档批量查找替换功能。如需签名或标注审阅，也可随时一键切换至经典批注模式。</p>
      <p>全流程纯本地客户端安全处理，无需上传云端服务器，保障您的文档隐私与安全。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放或选择需要编辑正文的 PDF 文件。' },
      { step: 2, title: '原位点击修改正文', description: '直接点击或双击 PDF 上的文字段落即可光标输入修改，支持实时智能换行。' },
      { step: 3, title: '样式调节与图像编辑', description: '在右侧检查器调整字体样式、段落对齐，或右键点击图片进行替换、翻转。' },
      { step: 4, title: '保存并下载', description: '点击右上方“保存修改”按钮，即可导出完美保持原始排版的新 PDF。' },
    ],
    useCases: [
      { title: '直接修改正文错误', description: '无需重新导出源文件，直接在 PDF 原位更正错别字、日期或金额。', icon: 'edit-3' },
      { title: '全文档查找替换', description: '跨页面批量查找关键词并一键原位替换，大幅提升合同修改效率。', icon: 'search' },
      { title: '图片替换与排版', description: '一键替换 PDF 中的老旧图片、印章或 Logo，保持版面规范整齐。', icon: 'image' },
    ],
    faq: [
      { question: '可以直接修改PDF现有的文字吗？', answer: '是的！本工具现已全面支持原位正文直接编辑。点击任意正文段落即可直接光标输入编辑，系统会自动计算字距并进行实时排版重排。' },
      { question: '如何进行经典的批注与签名？', answer: '您可以随时点击编辑器顶部的“模式切换”药丸按钮，无缝切换到经典批注模式添加画笔、图章、形状与文本框。' },
      { question: '我的文件安全吗？', answer: '非常安全。所有核心解析、文本重排和 PDF 保存均在您的浏览器本地 WASM 引擎中运行，文档不会上传至任何远程服务器。' },
    ],
  },
  ...
  'redact-pdf': {
    title: 'PDF 涂黑与马赛克脱敏',
    metaDescription: '可视化对 PDF 进行抹黑遮盖、马赛克打码或高斯模糊。物理像素级不可逆销毁与深度元数据清理，100% 本地离线保障隐私安全。',
    keywords: ['PDF脱敏', 'PDF抹黑', 'PDF打码', 'PDF马赛克', 'PDF隐私保护', 'PDF涂黑', '安全PDF编辑器'],
    description: `
      <p>PDF 涂黑与马赛克脱敏工具为您提供直观的可视化交互编辑能力，帮助您永久遮蔽并清除文档中的各类隐私与涉密信息。只需使用鼠标拖拽框选敏感内容（如身份证号、姓名、住址、公章、签名、财务流水、证件照等），即可应用纯黑遮蔽、白条遮盖、马赛克或高斯模糊效果。</p>
      <p>与仅在文字上方覆盖矢量矩形的常规工具不同，本工具采用<strong>物理像素级不可逆固化与栅格化技术</strong>，将遮蔽区域直接融合烧录进页面，彻底销毁底层的文字对象、矢量路径与 OCR 文本流，任何人均无法通过复制、文本提取或反编译逆向还原原始内容。</p>
      <p>同时，工具提供深度元数据清理功能，彻底抹除作者、软件历史指纹与 XMP 扩展流。所有运算均在您的浏览器本地内存中完成，零文件上传，全面满足企业与法务的严苛合规要求。</p>
    `,
    howToUse: [
      { step: 1, title: '上传 PDF 文档', description: '拖拽或点击选择需要进行隐私脱敏的 PDF 文件。' },
      { step: 2, title: '框选敏感区域', description: '在页面上按住鼠标左键拖拽画出需要遮蔽的区域，支持拖拽手柄缩放调整与移动。' },
      { step: 3, title: '选择脱敏效果', description: '选择涂黑遮蔽、白条遮盖、马赛克打码（可调颗粒度）或高斯模糊，可随时开启实时预览验证效果。' },
      { step: 4, title: '生成并下载安全文档', description: '点击“生成脱敏安全 PDF”，系统自动完成物理像素固化与元数据深度清理，即可一键下载。' },
    ],
    useCases: [
      { title: '法规合规与隐私保护', description: '对身份证号、手机号、人脸肖像等敏感个人信息 (PII) 进行合规脱敏，满足数据保护法规。', icon: 'shield' },
      { title: '涉密与法务公文披露', description: '在向外部共享合同、法务文书或调查报告前，对商业机密、签名公章与调解条款进行永久遮蔽。', icon: 'file-text' },
      { title: '财务凭证与票据分享', description: '对银行回单、薪资表、发票流水等财务单据中的敏感账号与金额进行安全打码。', icon: 'lock' },
    ],
    faq: [
      { question: '脱敏后的内容能否被复制或技术手段还原？', answer: '绝对无法还原。工具采用了物理不可逆像素栅格化技术，底层的文本图元已被彻底物理抹除，复制文本或使用反编译软件也无法提取任何底层信息。' },
      { question: '涂黑遮蔽、马赛克与高斯模糊有什么区别？', answer: '涂黑为标准的公文涉密黑框（最严肃正规）；白条遮盖保持页面底色干净；马赛克具有现代化数码打码效果；高斯模糊则带来柔和的毛玻璃磨砂质感。' },
      { question: '我的文件会被上传到云端服务器吗？', answer: '不会。整个渲染、打码、元数据清理和新文档生成过程 100% 运行在您本地浏览器的内存中，无任何网络上传请求。' },
      { question: '系统会清理哪些文档元数据？', answer: '包括文档标题 (Title)、作者 (Author)、主题 (Subject)、关键词 (Keywords)、制作者 (Producer)、创建与修改时间，以及 XMP 扩展元数据流。' },
    ],
  },
  'decrypt-pdf': {
    title: '解密PDF',
  ...
  'cert-cryptor': {
    ...
    faq: [
      ...
      { question: '火漆印章的压花可以自定义吗？', answer: '可以。我们默认提供 TPSH PDF 防伪标识、Royal 徽章等多种压花图案，并支持您在控制面板调节火漆的蜡熔范围及凹凸深度。' },
    ],
  },
